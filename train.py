...
def train(model, train_graphs, val_graphs, num=1, re_train_start=0, b_loss=999):
    ...
    new_path1 = configs.train_dataset_path
    new_path2 = configs.val_dataset_path
    with open(new_path1, 'wb') as f:
        pickle.dump(train_data, f)
    with open(new_path2, 'wb') as f:
    ...
    for e in range(epochs):
        ...
        for train_g in train_graphs:
            ...
            train_ag_label[:,1] = (train_ag_label[:,1] == 1).int()  
