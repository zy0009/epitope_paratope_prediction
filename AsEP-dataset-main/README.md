...
数据集存放位置：由/path/to/WALLE/AsEP-dataset-main/experiments/train-walle/conf/dataset/dataset.yaml 里写的位置决定
root: /path/to/WALLE/asep-dataset   
name: asep  则把数据集放在/path/to/WALLE/asep-dataset/asep/raw下
